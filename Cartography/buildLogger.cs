...
namespace Cartography
{
    public partial class buildLogger : Form
    {
        ...
        {
            TextBox logMessageTarget = this.buildLogger_textBox_logDisplay;
            ...
            for (int i = 0; i < (int)assemblies.Length; i++)
            {
                ...
                if (assembly.EntryPoint != null)
                {
                    ...
                    logMessageTarget = this.buildLogger_textBox_logDisplay;
        ...
        {
            TextBox textLog = this.buildLogger_textBox_logDisplay;
        ...
        public void LogTimeStamp()
        {
            ...
            textLog = this.buildLogger_textBox_logDisplay;
        ...
        private void buildLogger_menuStrip_button_saveLog_Click(object sender, EventArgs e)
        {
            ...
            if (Log.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    sw.Write(this.buildLogger_textBox_logDisplay.Text);
                    sw.Flush();
                }
            }
        }
