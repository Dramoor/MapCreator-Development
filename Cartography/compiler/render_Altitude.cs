...
namespace Altitude
{
    ...
    public class ClsAltitudeTable
    {
        ...
        public void SaveACO()
        {
            ...
            string str = string.Format("{0}/Development/DrawingTools/AdobePhotoshop/ColorSwatches/Altitude.aco", Directory.GetCurrentDirectory());
        ...
        public void SaveACT()
        {
            ...
            string str = string.Format("{0}/Development/DrawingTools/AdobePhotoshop/OptimizedColors/Altitude.act", Directory.GetCurrentDirectory());
