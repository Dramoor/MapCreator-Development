...
namespace Terrain
{
    ...
    public class ClsTerrainTable
    {
        ...
        public void SaveACO()
        {
            ...
            string str = string.Format("{0}/Development/DrawingTools/AdobePhotoshop/ColorSwatches/Terrain.aco", Directory.GetCurrentDirectory());
        ...
        public void SaveACT()
        {
            ...
            string str = string.Format("{0}/Development/DrawingTools/AdobePhotoshop/OptimizedColors/Terrain.act", Directory.GetCurrentDirectory());
